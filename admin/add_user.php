...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO gen_m_persona (tipo_identificacion, numero_identificacion, nombre1, nombre2, apellido1, apellido2, fecha_nacimiento, sexo_biologico, direccion, telefono_movil, email) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$tipo_id, $num_id, $nombre1, $nombre2, $apellido1, $apellido2, $fecha_nac, $sexo, $direccion, $telefono, $email]);
...
<head>
    ...
    <title>Agregar Usuario - Panel de Administración</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4 text-center animate__animated animate__fadeIn">Agregar Nuevo Usuario</h1>
                ...
                <form action="add_user.php" method="post" id="addUserForm">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="num_id" name="num_id" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
